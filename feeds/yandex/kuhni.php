...
echo "\t<offers>\n";
        ...
        $array_items = mysqli_query ($link,"
            ...
            WHERE oc_product_to_category.category_id = 120 OR oc_product_to_category.category_id = 115 OR oc_product_to_category.category_id = 121
        ...
        ");
            while($item = mysqli_fetch_array($array_items))
            {
                ...
                echo " available=\"false\" bid=\"30\" cbid=\"30\" fee=\"100\">\n";
                    ...
                    echo "\t\t\t<url>https://mebel.furniture/kuxni/".$item['keyword']."</url>\n";
