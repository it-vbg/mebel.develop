...
//}
		...
		echo"<picture>http://automobile-gadgets.ru/images/shop/".$row_tovar['product_full_image']."</picture>\n";
...
*/
		...
		echo"<description>".$row_tovar['short_description_ru-RU']."</description>\n";
