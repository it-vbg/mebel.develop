...
{$al=$row341['alias_ru-RU'];}
        ...
        echo"<url>http://automobile-gadgets.ru/".$al."/".$row_tovar['alias_ru-RU'].".html?utm_source=google_merchant&amp;utm_medium=cpc&amp;utm_term=".$row_tovar['alias_ru-RU']."&amp;utm_campaign=avtogadzhet_moskva_i_oblast&amp;keyword={keyword}</url>\n";
...
*/
		...
		echo"<oldprice>".strip_tags($row_tovar['product_old_price'])."</oldprice>\n";
		}
