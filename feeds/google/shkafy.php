...
echo "<rss xmlns:g=\"http://base.google.com/ns/1.0\" version=\"2.0\">\n";
    echo "\t<channel>\n";
        ...
        $array_items = mysqli_query ($link,"
            ...
            WHERE oc_product_to_category.category_id = 95
        ...
        ");
            while($item = mysqli_fetch_array($array_items))
            {
                echo "\t\t<item>\n";
                    ...
                    echo "\t\t\t<g:link>https://mebel.furniture/shkafy/".$item['keyword']."/</g:link>\n";
                ...
                if ($item['special']){
                    ...
                    echo "\t\t\t<g:google_product_category>6356</g:google_product_category>\n";
