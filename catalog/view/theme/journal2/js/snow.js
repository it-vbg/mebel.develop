var snowStorm = null;
function SnowStorm() {
  var imagePath = imageDir ? imageDir : '/image/data/prazdnik/novyj_god/snezhinki/';
  ...
  var flakeBottom = sflakeBottom ? sflakeBottom : null;
  ...
  var zIndex = 999;
  var flakeLeftOffset = flakeWidth;
  var flakeRightOffset = flakeWidth;
  ...
  this.timerInit = function() {
    s.timers = (!isWin9X?[setInterval(s.snow,20)]:[setInterval(s.snow,25),setInterval(s.snow,25)]);
  }
