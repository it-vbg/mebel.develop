...
Journal.setupMenu = function (type) {
    ...
    var $mobiletrigger_katalog = $('.mobile-trigger-katalog');
    ...
    $mobiletrigger_katalog.unbind('click');
    ...
    if (type === 'mobile') {
        ...
        $mobiletrigger.toggle(function () {
            ...
            $('.mobile-menu-katalog').stop(true, true).slideUp(150);
            $('.mobile-menu-katalog').removeClass('menu-open');
        }, function () {
            $('.mobile-menu').stop(true, true).slideUp(150);
            $(this).removeClass('menu-open');
        });
        $mobiletrigger_katalog.toggle(function () {
            $('.mobile-menu-katalog').stop(true, true).slideDown(250);
            $(this).addClass('menu-open');
            $('.mobile-menu').stop(true, true).slideUp(150);
...
//Прятать выпадающее меню при клике за его пределами
$(document).ready(function () {
$(document).mouseup(function (e) {
    var container = $("ul.mobile-menu-dropdown");
