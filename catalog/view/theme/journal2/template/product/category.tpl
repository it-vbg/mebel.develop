  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <?php if($this->journal2->settings->get('refine_category') === 'grid' && $this->journal2->settings->get('refine_category_images', array())): ?>
          ...
          <?php if ($heading_title == 'Каталог корпусной мебели'){?>
              <div class="refine-images-sheme">
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                     <a href="/goctinaya">
                     <img class="first" src="/image/catalog/category/sheme/gostinaya.jpg" width="100" height="100">
                     <img class="second" src="/image/catalog/category/sheme/gostinaya-hover.jpg" width="100" height="100">
                     <div class="refine-category-sheme-name">Гостиная</div>
                     </a>
                  </div>
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                      <a href="/shkafi">
                          <img class="first" src="/image/catalog/category/sheme/shkafy.jpg" width="100" height="100">
                          <img class="second" src="/image/catalog/category/sheme/shkafy-hover.jpg" width="100" height="100">
                          <div class="refine-category-sheme-name">Шкафы</div>
                      </a>
                  </div>
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                      <a href="/detckaya">
                          <img class="first" src="/image/catalog/category/sheme/detskaya.jpg" width="100" height="100">
                          <img class="second" src="/image/catalog/category/sheme/detskaya-hover.jpg" width="100" height="100">
                          <div class="refine-category-sheme-name">Детская</div>
                      </a>
                  </div>
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                      <a href="/prixozhaya">
                          <img class="first" src="/image/catalog/category/sheme/prihozhaya.jpg" width="100" height="100">
                          <img class="second" src="/image/catalog/category/sheme/prihozhaya-hover.jpg" width="100" height="100">
                          <div class="refine-category-sheme-name">Прихожая</div>
                      </a>
                  </div>
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                      <a href="/kuxnya">
                          <img class="first" src="/image/catalog/category/sheme/kuhnya.jpg" width="100" height="100">
                          <img class="second" src="/image/catalog/category/sheme/kuhnya-hover.jpg" width="100" height="100">
                          <div class="refine-category-sheme-name">Кухня</div>
                      </a>
                  </div>
                  <div class="refine-image-sheme xs-33 sm-33 md-16 lg-16 xl-16">
                      <a href="/cpal-nya">
                          <img class="first" src="/image/catalog/category/sheme/spalnya.jpg" width="100" height="100">
                          <img class="second" src="/image/catalog/category/sheme/spalnya-hover.jpg" width="100" height="100">
                          <div class="refine-category-sheme-name">Спальня</div>
                      </a>
                  </div>
              </div>
          <?php }else{ ?>
            ...
            <?php foreach ($this->journal2->settings->get('refine_category_images', array()) as $category): ?>
              ...
              <a href="<?php echo $category['href']; ?>">
                  <img style="display: block" width="<?php echo $this->journal2->settings->get('refine_image_width', 175); ?>" height="<?php echo $this->journal2->settings->get('refine_image_height', 175); ?>" src="<?php echo $category['thumb']; ?>" alt="<?php echo $category['name']; ?>"/>
                  <div class="refine-image-bg">
                      <div class="refine-category-name"><span><?php echo $category['name']; ?></span></div>
                  </div>
              </a>
            </div>
            <?php endforeach; ?>
      ...
      <?php endif; ?>
        ...
        <div class="diler-tiser">
            <p>Мебельная фабрика «Вента», предлагает купить или заказать <strong><?php echo $heading_title; ?></strong> в СПб от производителя в розницу, оптом для дилеров, дизайн-студий, строительных компаний и предприятий на выгодных условиях. В нашем интернет-магазине, Вы найдете большой ассортимент уже готовой продукции, по доступным ценам.
                Каждый клиент получает <a href ="/optovikam.html" target="_blank" rel="nofollow" onclick="yaCounter45925443.reachGoal('dilers-category'); ga ('send', 'event', 'category', 'perehod', 'dilers-category'); return true;">индивидуальные условия сотрудничества!!!</a></p>
            <div class="modal-button"><button class="btn btn-green btn-lg btn-block order" data-loading-text="Загрузка..." data-product="Заказать звонок" data-remodal-target="modal" type="button"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Заказать звонок</button></div>
        </div>
      ...
      <div class="product-filter">
        <div class="display">
          ...
          <div class="pagination col-sm-6 links"><?php echo $pagination; ?></div>
      ...
      <div class="row main-products product-<?php echo $category_view ;?>" data-grid-classes="<?php echo $this->journal2->settings->get('product_grid_classes'); ?> display-<?php echo $this->journal2->settings->get('product_grid_wishlist_icon_display'); ?> <?php echo $this->journal2->settings->get('product_grid_button_block_button'); ?>">
        <?php foreach ($products as $product) { ?>
        <div class="product-<?php echo $category_view ;?>-item <?php echo $this->journal2->settings->get('product_grid_classes'); ?>">
            ...
            <?php if($product['attribute_groups']) { ?>
                ...
                <?php } ?>
            <?php } ?>
          <div class="product-thumb product-wrapper <?php echo $akcii_class; ?> <?php echo $this->journal2->settings->get('show_countdown', 'never') !== 'never' && isset($product['date_end']) && $product['date_end'] ? 'has-countdown' : ''; ?> <?php echo isset($product['labels']) && is_array($product['labels']) && isset($product['labels']['outofstock']) ? 'outofstock' : ''; ?>">
