...
if (!function_exists('renderMultiLevelMenu')) {
...
?>
<style><?php echo implode(' ', $color_styles); ?></style>

<?php if ($device === 'phone'){ ?>
<div class="mobile-trigger-katalog">Каталог</div>
<div class="mobile-akcii"><a href="https://mebel.furniture/special"><span class="main-menu-text">Акции и скидки</span></a></div>
<?php } ?>
<div class="mobile-trigger"><?php echo $this->journal2->settings->get('mobile_menu_text'); ?></div>

<?php //Выпадающее меню каталога в телефоне ?>
<?php if ($device === 'phone'){ ?>
<ul class="super-menu mobile-menu-katalog mobile-menu-dropdown menu-<?php echo $display; ?>" style="table-layout: <?php echo $table_css_style; ?>">
<?php foreach ($menu_items as $menu_item): ?>
    <li class="<?php echo $menu_item['type']; ?> <?php echo $menu_item['class']; ?>">
<?php if ($menu_item['id'] == 'main-menu-item-1') {?>
...
<?php } ?>
<?php //Конец Выпадающее меню каталога в телефоне ?>


<ul class="super-menu mobile-menu <?php if ($device === 'phone'){ ?>mobile-menu-dropdown<?php } ?> menu-<?php echo $display; ?>" style="table-layout: <?php echo $table_css_style; ?>">
    <?php foreach ($menu_items as $menu_item): ?>
    <li id="<?php echo $menu_item['id']; ?>" class="<?php echo $menu_item['type']; ?> <?php echo $menu_item['class']; ?>">
