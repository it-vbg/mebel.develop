<div class="sf-price <?php echo $price_slider == '1' ? '' : 'sf-input'; ?> box <?php echo $is_collapsed ? 'is-collapsed' : ''; ?>" data-id="price" data-min-price="<?php echo $min_price; ?>" data-max-price="<?php echo $max_price; ?>" style="display: block;">
