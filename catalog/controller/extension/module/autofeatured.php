...
class ControllerExtensionModuleAutoFeatured extends Controller {
	public function index($setting) {
		...
		$data['heading_title'] = $setting['titleview'] ? $setting['title'][(int)$this->config->get('config_language_id')]['name'] . $results['text'] : $setting['title'][(int)$this->config->get('config_language_id')]['name'];
		...
		if ($data['products']) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/extension/module/autofeatured.tpl')) {
