          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div id="category-list-source" class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($category_source as $category) { ?>
                <div id="category-list-source<?php echo $category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $category['name']; ?>
                  <input type="hidden" name="category_source[]" value="<?php echo $category['category_id']; ?>" />
                </div>
                <?php } ?>
              </div>
            </div>
