...
<div class="content reg_socnetauth2_bline_content" style="min-height: 0px;">
	<style>
	a.socnetauth2_buttons:hover img
	{
		opacity: 0.8;
	...
	#socnetauth2_label#	
	<div  class="reg_socnetauth2_bline_links" style="padding-top: 10px;">
		
				<?php if( !empty($socnetauth2_socnets[0]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[0]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[0]['short']; ?>45.png"></a><?php } ?>
				<?php if( !empty($socnetauth2_socnets[1]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[1]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[1]['short']; ?>45.png"></a><?php } ?>
				<?php if( !empty($socnetauth2_socnets[2]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[2]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[2]['short']; ?>45.png"></a><?php } ?>
				<?php if( !empty($socnetauth2_socnets[3]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[3]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[3]['short']; ?>45.png"></a><?php } ?>
				<?php if( !empty($socnetauth2_socnets[4]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[4]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[4]['short']; ?>45.png"></a><?php } ?>
				<?php if( !empty($socnetauth2_socnets[5]) ) { ?><a class="socnetauth2_buttons" href="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/<?php echo $socnetauth2_socnets[5]['key']; ?>.php?first=1"><img src="<?php echo $socnetauth2_shop_folder; ?>/socnetauth2/icons/<?php echo $socnetauth2_socnets[5]['short']; ?>45.png"></a><?php } ?>
...
<div class="content reg_socnetauth2_icons_content" style="min-height: 0px;">
	<div  class="reg_socnetauth2_lline_links">
		<table>
			<tr>
