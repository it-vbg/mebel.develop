...
-->
	  ...
	  <p><?php echo $text_design_notice2; ?></p>
		...
		<tr>
			...
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_account.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
			<td class="left"><?php echo $text_design_row_socnetauth2_checkout; ?></td>
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_checkout.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
			<td class="left"><?php echo $text_design_row_socnetauth2_simple; ?></td>
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_simple.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
			<td class="left"><?php echo $text_design_row_socnetauth2_simplereg; ?></td>
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_simplereg.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
			<td class="left"><?php echo $text_design_row_socnetauth2_reg; ?></td>
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_reg.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="left">/admin/view/template/extensions/module/socnetauth2_blocks/socnetauth2_confirm.tpl</td>
			<td class="left"><?php echo $text_design_notice; ?></td>
		</tr>
		<tr>
