...
{title:"Всплывающая кнопка",image:"template1.gif",description:"При клике на кнопку всплывает окно.",html:
'<div class="modal-button">' +
'<button type="button" data-loading-text="Загрузка..." class="btn btn-oneclick btn-lg btn-block order" data-toggle="modal" data-target="#simple-modal" data-product="' +
'Заказ на вызов замерщика' +
'"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;' +
'Вызвать замерщика' +
'</button>' +
'</div>'
},
{title:"всвыаа",image:"template2.gif",description:"A template that defines two columns, each one with a title, and some text.",
