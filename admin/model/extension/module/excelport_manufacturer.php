...
class ModelExtensionModuleExcelportmanufacturer extends ModelExtensionModuleExcelport {
    public function importXLSManufacturers($file, $importLimit = 100) {
        ...
        do {
            ...
            if (!empty($manufacturer_name)) {
                $manufacturer_id = $manufacturersSheetObj->getCell(PHPExcel_Cell::stringFromColumnIndex($source[0] + $manufacturer_map['manufacturer_id']) . ($source[1]))->getValue();
