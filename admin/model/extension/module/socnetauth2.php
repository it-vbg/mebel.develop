...
class ModelExtensionModuleSocnetauth2 extends Model 
{
	...
	public function makeCode($data)
	{
		...
		$template_data['socnetauth2_shop_folder'] = $data['socnetauth2_shop_folder'];
		...
		$data['socnetauth2_confirm_block'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_confirm.tpl', $template_data);
		
		$template_data['socnetauth2_format'] = 'kvadrat';
		
		$data['socnetauth2_reg_code_kvadrat'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg.tpl', $template_data);
		$data['socnetauth2_simplereg_code_kvadrat'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg.tpl', $template_data);
		$data['socnetauth2_simple_code_kvadrat']    = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple.tpl', $template_data);
		$data['socnetauth2_account_code_kvadrat']   = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account.tpl', $template_data);
		$data['socnetauth2_checkout_code_kvadrat']  = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout.tpl', $template_data);
		
		$template_data['socnetauth2_format'] = 'bline';
		
		$data['socnetauth2_reg_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg.tpl', $template_data);
		$data['socnetauth2_simplereg_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg.tpl', $template_data);
		$data['socnetauth2_simple_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple.tpl', $template_data);
		$data['socnetauth2_account_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account.tpl', $template_data);
		$data['socnetauth2_checkout_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout.tpl', $template_data);
		
		$template_data['socnetauth2_format'] = 'lline';
		
		$data['socnetauth2_reg_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg.tpl', $template_data);
		$data['socnetauth2_simplereg_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg.tpl', $template_data);
		$data['socnetauth2_simple_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple.tpl', $template_data);
		$data['socnetauth2_account_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account.tpl', $template_data);
		$data['socnetauth2_checkout_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout.tpl', $template_data);
