...
class ControllerExtensionModulePvnmStorageCleaner extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			//$this->response->redirect($this->url->link('extension/module/pvnm_storage_cleaner', 'token=' . $this->session->data['token'], true));
	...
	public function clearLog() {
		...
		if (!$this->user->hasPermission('modify', 'extension/module/pvnm_storage_cleaner') || empty($this->request->post['key'])) {
			$json['error'] = $this->language->get('error_permission');
		} else {
			$key = $this->request->post['key'];
