<form action="aristo.html" class="UniForm">
    <div id="field1-container" class="field radio-group">
        ...
        <div class="option clearfix">
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/gostinnaya-20-250x250.jpg" width="180px" height="180px" alt="расчет гостинной" />
            </div>
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/shkafy-250x250.jpg" width="180px" height="180px" alt="расчет шкафа" />
            </div>
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/children-250x250.jpg" width="180px" height="180px" alt="расчет детской" />
            </div>
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/prihozhaya-250x250.jpg" width="180px" height="180px" alt="расчет прихожей" />
            </div>
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/kuhnya-24-250x250.jpg" width="180px" height="180px" alt="Расчет кухни" />
            </div>
            <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-15">
                ...
                <img src="/image/cache/catalog/category/bedroom-34-250x250.jpg" width="180px" height="180px" alt="расчет спальни" />
            </div>
       ...
       <select id="gostinnaya" style='display: none;' class="ventaform">
       ...
       <select id="shkafy" style='display: none;' class="ventaform">
        ...
        <select id="children" style='display: none;' class="ventaform">
        ...
        <select id="prihozhaya" style='display: none;' class="ventaform">
        ...
        <select id="kuhnya" style='display: none;' class="ventaform">
        ...
        <select id="bedroom" style='display: none;' class="ventaform">
    ...
    <div id="field2-container" class="field radio-group">
            ...
            <div class="option clearfix">
                <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-20">
                    <input type="radio" class="ventaform" name="planirovka" value="Прямая" required>
                    <span class="option-title">
                        Прямая
                </span>
                    <img src="/image/calcs/pryamaya.jpg" width="200px" height="134px" alt="Прямая" />
                </div>
                <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-20">
                    ...
                    <img src="/image/calcs/uglovaya-left.jpg" width="200px" height="134px" alt="Угловая левая" />
                </div>
                <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-20">
                    ...
                    <img src="/image/calcs/uglovaya-right.jpg" width="200px" height="134px" alt="Угловая правая" />
                </div>
                <div class="form-imgbg xs-50 sm-50 md-33 lg-20 xl-20">
                    ...
                    <img src="/image/calcs/p-obraz.jpg" width="200px" height="134px" alt="П-образная" />
                </div>
            </div>
    </div>
    ...
    <div id="field4-container" class="field input-group">
        ...
        <input name="tel" placeholder="Телефон" required="required" type="tel">
    ...
    <div id="field5-container" class="field file">
        ...
        <input class="ventaform" name="file" id="field5" type="file">
    </div>
...
<link rel="stylesheet" href="/utils/uniform/css/venta.css">
